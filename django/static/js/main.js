...
},{"./cjs/react.development.js":"../node_modules/react/cjs/react.development.js"}],"tabNav.jsx":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.Tab = exports.TabNav = undefined;
...
var TabNav = exports.TabNav = function (_React$Component) {
    ...
    function TabNav(props) {
        ...
        if (props.tabs.length > 0) _this.state = {
                ...
                _react2.default.createElement(
                    ...
                    this.props.tabs.map(function (tab, index) {
                        return _react2.default.createElement(Tab, {
                            key: index,
                            tab: tab,
                            active: tab === _this2.state.activeTab,
                            onTabClick: _this2.tabClicked });
                    })
                ),
                _react2.default.createElement(
                    'div',
...
var Tab = exports.Tab = function (_React$Component2) {
    ...
    _createClass(Tab, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'li',
                { className: 'tab-item c-hand' },
                _react2.default.createElement(
                    'a',
                    { className: this.props.active ? 'active' : '', onClick: this.handleTabClick },
                    this.props.tab.name
                )
            );
        }
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"util.jsx":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.ClickToCopy = undefined;
...
function Size(props) {
    ...
    var formattedSize = Math.round(coefficient * 100) / 100 + ' ' + units;
    return _react2.default.createElement(
        'span',
        null,
        formattedSize
...
var ClickToCopy = exports.ClickToCopy = function (_React$Component) {
    _inherits(ClickToCopy, _React$Component);

    function ClickToCopy(props) {
        _classCallCheck(this, ClickToCopy);

        var _this = _possibleConstructorReturn(this, (ClickToCopy.__proto__ || Object.getPrototypeOf(ClickToCopy)).call(this, props));

        _this.state = {
            toolTipText: _this.props.text
        };

        _this.copyText = _this.copyText.bind(_this);
        _this.resetText = _this.resetText.bind(_this);
        return _this;
    }
    ...
    _createClass(ClickToCopy, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'a',
                { className: 'btn btn-link tooltip click-to-copy', 'data-tooltip': this.state.toolTipText, onMouseEnter: this.resetText, onClick: this.copyText },
                snippedText
            );
        }
    }]);
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            props.files.map(function (file, index) {
                return _react2.default.createElement(FileTreeNode, { key: file.id, file: file, depth: 0 });
            })
        )
    );
}

var FileTreeNode = exports.FileTreeNode = function (_React$Component) {
    _inherits(FileTreeNode, _React$Component);

    function FileTreeNode(props) {
        _classCallCheck(this, FileTreeNode);

        var _this = _possibleConstructorReturn(this, (FileTreeNode.__proto__ || Object.getPrototypeOf(FileTreeNode)).call(this, props));
        ...
        _this.receiveChildren = _this.receiveChildren.bind(_this);
        return _this;
    }
    ...
    _createClass(FileTreeNode, [{
        ...
        value: function handleClick() {
            if (this.state.collapsed) {
                if (this.state.childrenLoaded) {
                    ...
                    _axios2.default.get('/api/files/' + this.props.file.id + '/children').then(this.receiveChildren).catch(function (error) {
                        console.log(error);
                    });
                }
            } else {
        ...
        key: 'receiveChildren',
        value: function receiveChildren(response) {
        ...
        value: function render() {
            ...
            if (this.props.file.is_folder) {
                var icon = void 0;
                if (this.state.collapsed) icon = 'fa-caret-right';else if (this.state.childrenLoaded) icon = 'fa-caret-down';else icon = '';
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'tr',
                        { className: 'c-hand', onClick: this.handleClick },
                        _react2.default.createElement(
                            'td',
                            { style: { paddingLeft: 30 * this.props.depth } },
                        ...
                        _react2.default.createElement(
                            'td',
                            null,
                            _react2.default.createElement(_util.Size, { bytes: this.props.file.total_size })
                        )
                    ),
                    this.state.childrenLoaded && !this.state.collapsed && this.props.file.children.map(function (child) {
                        return _react2.default.createElement(FileTreeNode, {
                            file: child,
                            key: child.id,
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'td',
                        null,
                        _react2.default.createElement(_util.Size, { bytes: this.props.file.size })
                    )
                );
            }
        }
...
var LoadingBox = exports.LoadingBox = function (_React$Component) {
    _inherits(LoadingBox, _React$Component);

    function LoadingBox(props) {
        _classCallCheck(this, LoadingBox);

        var _this = _possibleConstructorReturn(this, (LoadingBox.__proto__ || Object.getPrototypeOf(LoadingBox)).call(this, props));
        ...
        _this.checkForUpdate = _this.checkForUpdate.bind(_this);
        _this.getFromServer = _this.getFromServer.bind(_this);

        _this.interval = setInterval(_this.checkForUpdate, 10000);
    ...
    _createClass(LoadingBox, [{
        ...
        value: function checkForUpdate() {
            if (this.props.checkForUpdate) {
                _axios2.default.get('/api/updates/latest').then(function (response) {
        ...
        value: function getFromServer() {
            _axios2.default.get(this.props.get).then(function (response) {
                this.setState({
                    loading: false,
                    updateInProgress: false,
                    error: false
        ...
        key: 'render',
        value: function render() {
            if (this.state.updateInProgress) return _react2.default.createElement(
                'div',
                { className: 'empty' },
                _react2.default.createElement(
                    'div',
                    { className: 'empty-icon' },
                    _react2.default.createElement('div', { className: 'loading loading-lg' })
                ),
                _react2.default.createElement(
                    'p',
                    { className: 'empty-title h5' },
                    'A database update is in progress'
                ),
                _react2.default.createElement(
                    'p',
            ...
            if (this.state.loading) return _react2.default.createElement('div', { className: 'loading loading-lg' });
...
},{"axios":"../node_modules/axios/index.js","react":"../node_modules/react/index.js"}],"browseTab.jsx":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.BrowseTab = undefined;
...
var BrowseTab = exports.BrowseTab = function (_React$Component) {
    _inherits(BrowseTab, _React$Component);

    function BrowseTab(props) {
        _classCallCheck(this, BrowseTab);

        var _this = _possibleConstructorReturn(this, (BrowseTab.__proto__ || Object.getPrototypeOf(BrowseTab)).call(this, props));
        ...
        _this.searchBar = _react2.default.createRef();

        _this.searchFiles = _this.searchFiles.bind(_this);
        _this.clearSearch = _this.clearSearch.bind(_this);
        _this.onLoad = _this.onLoad.bind(_this);
        return _this;
    }

    _createClass(BrowseTab, [{
        key: 'onLoad',
        ...
        value: function searchFiles() {
            ...
            _axios2.default.post('/api/files/search', {
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                { get: '/api/files/top', callback: this.onLoad, checkForUpdate: true },
                _react2.default.createElement(
                    'div',
                    { className: 'container' },
                    _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement('input', { type: 'text', className: 'form-input', placeholder: 'Search...', ref: this.searchBar }),
                                        _react2.default.createElement(
                                            'button',
                                            { className: 'btn btn-primary input-group-btn', onClick: this.searchFiles },
                                            'Go'
                                        )
                                    )
                                ),
                                _react2.default.createElement(
                                    ...
                                    this.state.searching ? this.state.searchLoading ? _react2.default.createElement('div', { className: 'loading loading-lg' }) : _react2.default.createElement(
                                        _react2.default.Fragment,
                                        null,
                                        _react2.default.createElement(
                                            'div',
                                            ...
                                            _react2.default.createElement(
                                                'a',
                                                { className: 'float-right c-hand', onClick: this.clearSearch },
                                                'Stop searching'
                                            )
                                        ),
                                        _react2.default.createElement(_fileTree.FileTree, { files: this.state.searchResults })
                                    ) : _react2.default.createElement(_fileTree.FileTree, { files: this.state.files })
                                )
                            )
                        )
                    )
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            props.files.map(function (file) {
                return _react2.default.createElement(FileTableRow, {
                    file: file,
                    key: file.id });
            })
        )
...
function FileTableRow(props) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            null,
            snippedName,
            props.file.path && _react2.default.createElement(_util.ClickToCopy, { text: props.file.path })
        ),
        _react2.default.createElement(
            'td',
            null,
            _react2.default.createElement(_util.Size, { bytes: props.file.size || props.file.total_size })
        )
    );
}
...
var SummaryTab = exports.SummaryTab = function (_React$Component) {
    _inherits(SummaryTab, _React$Component);

    function SummaryTab(props) {
        _classCallCheck(this, SummaryTab);

        var _this = _possibleConstructorReturn(this, (SummaryTab.__proto__ || Object.getPrototypeOf(SummaryTab)).call(this, props));
    ...
    _createClass(SummaryTab, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                _loadingBox.LoadingBox,
                { get: '/api/files/summary', callback: this.onLoad, checkForUpdate: true },
                _react2.default.createElement(
                    'div',
                    { className: 'container' },
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'column' },
                            this.state.totals && _react2.default.createElement(
                                'div',
                                { className: 'panel' },
                                _react2.default.createElement(
                                    'div',
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'p',
                                        null,
                                        _react2.default.createElement('i', { className: 'fa fa-fw fa-area-chart' }),
                                        '\xA0',
                                        _react2.default.createElement(_util.Size, { bytes: this.state.totals.total_size }),
                                        ' occupied'
                                    )
                                ),
                                _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'column' },
                            this.state.topTenTypes && _react2.default.createElement(
                                'div',
                                { className: 'panel' },
                                _react2.default.createElement(
                                    'div',
                                ...
                                _react2.default.createElement(
                                    'div',
                                    { className: 'panel-body' },
                                    _react2.default.createElement(_fileTable.FileTable, {
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'column' },
                            this.state.topTenFiles && _react2.default.createElement(
                                'div',
                                { className: 'panel' },
                                _react2.default.createElement(
                                    'div',
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'column' },
                            this.state.topTenFolders && _react2.default.createElement(
                                'div',
                                { className: 'panel' },
                                _react2.default.createElement(
                                    'div',
...
},{"react":"../node_modules/react/index.js","axios":"../node_modules/axios/index.js","./fileTable":"fileTable.jsx","./util":"util.jsx","./loadingBox":"loadingBox.jsx"}],"updateTab.jsx":[function(require,module,exports) {
'use strict';
...
var UpdateTab = exports.UpdateTab = function (_React$Component) {
    _inherits(UpdateTab, _React$Component);

    function UpdateTab(props) {
        _classCallCheck(this, UpdateTab);

        var _this = _possibleConstructorReturn(this, (UpdateTab.__proto__ || Object.getPrototypeOf(UpdateTab)).call(this, props));
        ...
        _this.restoreUpdate = _this.restoreUpdate.bind(_this);
        _this.onLoad = _this.onLoad.bind(_this);
        return _this;
    }

    _createClass(UpdateTab, [{
        key: 'fileChanged',
        ...
        value: function requestUpdate() {
            if (this.state.file) {
                ...
                _axios2.default.post('/api/updates/uploadfile', formData).then(function (response) {
                    this.setState({
        ...
        key: 'restoreUpdate',
        value: function restoreUpdate(update) {
            console.log(arguments);
            _axios2.default.post('/api/updates/restore', {
                update_id: update.id
            }).then(function (response) {
                this.setState({
                    updates: [response.data].concat(this.state.updates)
        ...
        value: function render() {
            ...
            var disabled = this.state.updates.length > 0 && this.state.updates[0].in_progress;
            //console.log(buttons_disabled);
            return _react2.default.createElement(
                _loadingBox.LoadingBox,
                { get: '/api/updates/list', callback: this.onLoad, checkForUpdate: false },
                _react2.default.createElement(
                    'div',
                    { className: 'container' },
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'div',
                                    { className: 'panel-body' },
                                    _react2.default.createElement('input', { className: 'form-input', type: 'file', onChange: this.fileChanged })
                                ),
                                _react2.default.createElement(
                                    'div',
                                    { className: 'panel-footer' },
                                    _react2.default.createElement(
                                        'button',
                                        { className: 'btn btn-primary', onClick: this.requestUpdate, disabled: disabled },
                                        'Update from File'
                                    )
                                )
                            )
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement('input', { className: 'form-input', type: 'text', placeholder: 'Username' })
                                    ),
                                    _react2.default.createElement(
                                        'div',
                                        { className: 'form-group' },
                                        _react2.default.createElement('input', { className: 'form-input', type: 'password', placeholder: 'Password' })
                                    )
                                ),
                                _react2.default.createElement(
                                    'div',
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'div',
                                    { className: 'panel-body', style: { maxHeight: '400px' } },
                                    _react2.default.createElement(
                                        'table',
                                        { className: 'table' },
                                        _react2.default.createElement(
                                            ...
                                            this.state.updates.map(function (update) {
                                                return _react2.default.createElement(UpdateLogRow, { key: update.id, update: update, onRestore: _this2.restoreUpdate, disabled: disabled });
                                            })
                                        )
                                    )
                                )
...
var UpdateLogRow = function (_React$Component2) {
    _inherits(UpdateLogRow, _React$Component2);

    function UpdateLogRow(props) {
        _classCallCheck(this, UpdateLogRow);

        var _this3 = _possibleConstructorReturn(this, (UpdateLogRow.__proto__ || Object.getPrototypeOf(UpdateLogRow)).call(this, props));

        _this3.handleRestore = _this3.handleRestore.bind(_this3);
        return _this3;
    }

    _createClass(UpdateLogRow, [{
        key: 'handleRestore',
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'td',
                    null,
                    this.props.update.in_progress ? _react2.default.createElement(
                        'span',
                        { className: 'label label-warning' },
                        'In Progress'
                    ) : this.props.update.failed ? _react2.default.createElement(
                        'span',
                ...
                _react2.default.createElement(
                    'td',
                    null,
                    this.props.update.file && !this.props.update.failed && !this.props.update.in_progress && _react2.default.createElement(
                        'button',
                        { className: 'btn btn-primary', onClick: this.handleRestore, disabled: this.props.disabled },
                        'Restore'
                    )
                )
            );
...
},{"react":"../node_modules/react/index.js","axios":"../node_modules/axios/index.js","./loadingBox":"loadingBox.jsx"}],"../node_modules/schedule/cjs/schedule.development.js":[function(require,module,exports) {
/** @license React v16.5.2
...
var _browseTab = require('./browseTab');
...
var tabs = [{
    name: 'Summary',
    content: _react2.default.createElement(_summaryTab.SummaryTab, null)
}, {
    name: 'Browse Files',
    content: _react2.default.createElement(_browseTab.BrowseTab, null)
}, {
    name: 'Update Files',
    content: _react2.default.createElement(_updateTab.UpdateTab, null)
}];

_axios2.default.defaults.xsrfHeaderName = "X-CSRFTOKEN";
_axios2.default.defaults.xsrfCookieName = "csrftoken";

_reactDom2.default.render(_react2.default.createElement(_tabNav.TabNav, { tabs: tabs }), document.getElementById('main'));
},{"./tabNav":"tabNav.jsx","./browseTab":"browseTab.jsx","./summaryTab":"summaryTab.jsx","./updateTab":"updateTab.jsx","react":"../node_modules/react/index.js","axios":"../node_modules/axios/index.js","react-dom":"../node_modules/react-dom/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
